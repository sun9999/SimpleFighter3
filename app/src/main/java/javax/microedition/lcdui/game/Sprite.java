...
public class Sprite extends Layer {
	 ...
	 * <p>
	 * The current frame is rendered when {@link #paint(Canvas)} is called.
	 * <p>
	...
	protected void drawImage(Canvas canvas, int x, int y, Bitmap bsrc, int sx, int sy, int w, int h) {
	 ...
	 * frames. See the constructor {@link #Sprite(Bitmap, int, int)} for
